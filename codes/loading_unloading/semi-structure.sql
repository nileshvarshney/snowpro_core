...
SELECT 
    ...
    value:actors[0]::string as first_actor,
    value:ratings AS ratings,
    value:ratings.imdb_rating AS IMDB_rating,
    value:ratings.metacritic_rating_percentage AS metacritic_rating_percentage
FROM FILMS_ELT,LATERAL FLATTEN(INPUT => FILMS_ELT.json_variant) as value
